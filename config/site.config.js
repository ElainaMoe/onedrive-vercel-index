...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'admin@bili33.top',
  ...
  links: [
    ...
    {
      name: 'Telegram',
      link: 'https://t.me/GamerNoTitle',
    },
    {
      name: 'Twitter',
      link: 'https://twitter.com/@GamerNoTitle'
    }
  ],
